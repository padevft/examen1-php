            ...
            <div class="container-form d-flex flex-column gap-3">
                <div class="d-flex flex-column align-items-center gap-2">
                    <div class="d-flex col-12 col-md-6 flex-column gap-2">
                        ...
                        <input type="text" name="nom" id="name-login" class="form-control fw-semibold input-login" placeholder="Depart" />
                    </div>
                    <div class="d-flex col-12 col-md-6 flex-column gap-2">
                        <label for="fristname-login" class="fw-semibold">Destination</label>
                        <input type="text" name="prenom" id="fristname-login" class="form-control fw-semibold input-login" placeholder="Destination" />
                    </div>
                    <div class="d-flex col-12 col-md-6 flex-column gap-2">
                    ...
                    <div class="d-flex col-12 col-md-6 flex-column gap-2">
                        <label for="sexe-login" class="fw-semibold">Code</label>
                        <input type="number" name="prenom" id="fristname-login" class="form-control fw-semibold input-login" placeholder="Destination" />
